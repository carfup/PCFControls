...
export class BicValidator implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public getParams():void{
		...
		this._value = context.parameters.BICValue.raw!;
